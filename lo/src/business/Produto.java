...
public abstract class Produto implements Comparable<Produto> {
	...
	public void setDataFabricacao(LocalDateTime dataFabricacao) {
		...
		// Garante que a data de fabricaçao nao pode ser futura
	...
	public String toString() {
		return "Produdo: " + id + " - " + descricao + "   Pre�o: R$" + preco + "   Quant.: " + quantidade
				   + "   Fabrica��o: " + dataFabricacao.format(DateTimeFormatter.ofLocalizedDateTime(FormatStyle.SHORT));
	}

	/**
	 * é executado quando um objeto esta sendo removido da memoria.
	 */
	@Override
