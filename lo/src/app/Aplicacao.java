...
class Aplicacao {
	...
	public static void adicionarProduto(Estoque lista) throws ExcecaoEstoqueExcedido, ExcecaoEstoqueNegativo {
		...
		valor = JOptionPane.showInputDialog(null, "Qual produto deseja adicionar: 1 - Bem duravel, 2 - Bem de consumo.",
	...
	public static void main(String args[]) {
		...
		System.out.println("No main apos o try-catch-finally..");
